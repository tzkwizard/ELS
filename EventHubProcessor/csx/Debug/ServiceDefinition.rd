...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="EventHubProcessor" generation="1" functional="0" release="0" Id="d10d7d59-a337-45e1-871d-a85d80da3bd8" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="EventHubProcessorGroup" generation="1" functional="0" release="0">
      <settings>
        ...
        <aCS name="EventRole:MasterCollectionLink" defaultValue="">
          <maps>
            <mapMoniker name="/EventHubProcessor/EventHubProcessorGroup/MapEventRole:MasterCollectionLink" />
          </maps>
        </aCS>
      ...
      <maps>
        ...
        <map name="MapEventRole:MasterCollectionLink" kind="Identity">
          <setting>
            <aCSMoniker name="/EventHubProcessor/EventHubProcessorGroup/EventRole/MasterCollectionLink" />
          </setting>
        </map>
        ...
        <groupHascomponents>
          <role name="EventRole" generation="1" functional="0" release="0" software="C:\Users\24666\Documents\Visual Studio 2013\Projects\self\ELS\EventHubProcessor\csx\Debug\roles\EventRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
              ...
              <aCS name="MasterCollectionLink" defaultValue="" />
